...
public class TicTacToe{
    ...
    public static void main(String[] args) {
        ...
        while (true) {
            System.out.println("Enter a values from 1 to 9 : ");
            int user_pos= in.nextInt();
            while (ur_set.contains(user_pos) || comp_set.contains(user_pos)) {
                System.out.println();
                System.out.println(" Retry , Enter a values from 1 to 9 : ");
                 user_pos= in.nextInt();
            }
   ...
   public static int gen_random(){
    ...
    public static void p_holder(char[][]g_board,int pos, String user){
        char syb = 'X';
        if(user.equals("You")){
            syb = 'X';
            ur_set.add(pos);
